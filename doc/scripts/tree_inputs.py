...
treelab = {
   'x': [ 0, 4,   4,  8.0, 12.0, 16.0, 20.0,  26.0, 16.0, 19.0, 24.0, 23.0, 26.0, -7.0, -10],
   'y': [ 0, 0,   0, -0.5,  0.0, -0.2,  4.0,   6.0, -0.2, -3.0, -7.0, -1.0, -2.0,  0.0,   0.0],
   'r': [ 2, 2,0.75, 0.75, 0.75, 0.75,  0.4,   0.2,  0.5,  0.5,  0.2,  0.2,  0.2,  0.4,   0.4],
   'p': [-1, 0,   1,    2,    3,    4,    5,     6,    5,    8,    9,    9,   11,    0,    13],
   't': [ 1, 1,   3,    3,    3,    3,    3,     3,    3,    3,    3,    3,    3,    2,     2]
}
brancheslab = [[0,1], [1,2,3,4,5], [5,6,7], [5,8,9], [9,10], [9,11,12], [0,13,14]]

treelab = {
   'x': [ 0, 4,   4,  8.0, 12.0, 20.0,  26.0, 12.0, 19.0, 24.0, 23.0, 26.0, -7.0, -10],
   'y': [ 0, 0,   0, -0.5,  0.0,  4.0,   6.0,  0.0, -3.0, -7.0, -1.0, -2.0,  0.0,   0.0],
   'r': [ 2, 2,0.75, 0.75, 0.75,  0.4,   0.2,  0.5,  0.5,  0.2,  0.2,  0.2,  0.4,   0.4],
   'p': [-1, 0,   1,    2,    3,    4,     5,    4,    7,    8,    8,   10,    0,    12],
   't': [ 1, 1,   3,    3,    3,    3,     3,    3,    3,    3,    3,    3,    2,     2]
}
brancheslab = [[0,1], [1,2,3,4], [4,5,6], [4,7,8], [8,9], [8,10,11], [0,12,13]]
