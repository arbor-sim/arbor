...
tree. A *segment* is constructed between a sample and its parent, and inherits the sample's tag, regardless of
whether or not its tag matches the parent's tag. This means that there are no gaps in the resulting segment tree.
...
(tags 2, 3 and 4 respectively) are allowed in this interpretation.
