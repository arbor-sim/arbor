...
.. cpp:class:: lif_cell
    ...
    .. cpp::function:: benchmark_cell(const cell_tag_type& source, const cell_tag_type& target, schedule, realtime_ratio)
        ...
        :cpp:class:`arb::recipe` by creating a :cpp:class:`connection`.
