...
file formats; see :ref:`morphology formats <formatsmorph>` for details.
...
:cpp:type:`morphology` object using one of the following functions: (See :ref:`morphology formats <formatsmorph>`
for more details).
