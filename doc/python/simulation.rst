...
.. glossary::
    ...
    probeset id
        A designator for one or more probes as specified by a recipe. The *probeset id* is a
    ...
    sampler
        ...
        particular measuring schedule, and then having a :term:`handle` with which to access the recorded probe data later on.
    ...
    handle
        ...
        by passing the handle associated to a sampler (associated to a probe) to :py:func:`simulation.samples`.
