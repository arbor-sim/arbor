...
cell_group_factory cell_kind_implementation(cell_kind, backend_kind, execution_context);

inline bool cell_kind_supported(cell_kind c, backend_kind b, execution_context ctx) {
