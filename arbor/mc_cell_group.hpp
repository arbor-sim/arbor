...
public:
    ...
    std::vector<std::tuple<cell_gid_type, std::string, lid_range>> get_target_table() const override;
    std::vector<std::tuple<cell_gid_type, std::string, lid_range>> get_gap_junction_table() const override;
