    ...
    unsigned n)
{
    ...
    launch(griddim, blockdim, kernels::gather<arb_value_type, arb_index_type>, from, to, p, n);
}
    ...
    unsigned n)
{
    ...
    launch(griddim, blockdim, kernels::scatter<arb_value_type, arb_index_type>, from, to, p, n);
}
