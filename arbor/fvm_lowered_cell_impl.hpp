    ...
    probe_association_map& probe_map)
{
    ...
    for (auto& m: mech_data.mechanisms) {
        ...
        case arb_mechanism_kind::point:
            ...
            break;
        case arb_mechanism_kind::density:
            ...
            break;
        case arb_mechanism_kind::reversal_potential:
        ...
        if (config.kind==arb_mechanism_kind::reversal_potential) {
