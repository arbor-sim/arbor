...
ARB_PP_FOREACH(ARB_UNARY_ARITHMETIC_,  neg, abs, sin, cos, exp, log, expm1, exprelr, sqrt, heaviside_right, heaviside_left, signum)
...
namespace detail {
    ...
    public:
        ...
        ARB_PP_FOREACH(ARB_DECLARE_UNARY_ARITHMETIC_,  neg, abs, sin, cos, exp, log, expm1, exprelr, sqrt, heaviside_right, heaviside_left, signum)
