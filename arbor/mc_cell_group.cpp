...
void mc_cell_group::serialize(serdes::serializer& ser,
                           const std::string& k) const { write(ser, k, *this); }
void mc_cell_group::deserialize(serdes::serializer& ser,
                             const std::string& k) { read(ser, k, *this); }
