        ...
        cell_kind ck, backend_kind bk, const execution_context& ctx)
{
    ...
    case cell_kind::cable:
        return [bk, ctx](const gid_vector& gids, const recipe& rec, cell_labeled_ranges& cg_sources, cell_labeled_ranges& cg_targets) {
    ...
    case cell_kind::spike_source:
        ...
        return [](const gid_vector& gids, const recipe& rec, cell_labeled_ranges& cg_sources, cell_labeled_ranges& cg_targets) {
