...
if [[ "${WITH_PYTHON}" == "true" ]]; then
    ...
    python$PY $python_path/example/single_cell_detailed.py $python_path/example/single_cell_detailed.swc         || error "running python single_cell_detailed example"
    progress "Python example: single_cell_detailed_recipe"
    python$PY $python_path/example/single_cell_detailed_recipe.py $python_path/example/single_cell_detailed.swc  || error "running python single_cell_detailed_recipe example"
