...
function("make_catalogue")
  ...
  if(MK_CAT_VERBOSE)
    ...
    message("Arbor cxx flags:      ${ARB_CXX_FLAGS_FULL}")
  ...
  if(NOT ARB_CXX_FLAGS_FULL STREQUAL "")
      set_source_files_properties(${catalogue_${MK_CAT_NAME}_source} COMPILE_FLAGS ${ARB_CXX_FLAGS_FULL})
  endif()
