...
anc::path trace_io::find_datadir() {
...
std::map<std::string, trace_data<double>> trace_io::load_traces(const anc::path& name) {
    anc::path file  = datadir_/name;
