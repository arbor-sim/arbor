...
public:
    ...
    util::unique_any get_cell_description(cell_gid_type i) const override {
        ...
        auto cell = make_basic_cell_tiled(morph, param_.num_compartments, param_.num_synapses,
...
{
    return std::unique_ptr<recipe>(new basic_rgraph_tiled_recipe(ncell, ntiles, param, pdist));
}
