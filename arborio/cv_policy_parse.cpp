...
eval_map {{"default",
          ...
          {"max-extent",
           make_call<double>([] (double i) { return arb::cv_policy_max_extent_um(i); },
                             "'max-extent' with one argument (max-extent (length:double))")},
          {"max-extent",
           make_call<double, region>([] (double i, const region& r) { return arb::cv_policy_max_extent_um(i, r); },
                                     "'max-extent' with two arguments (max-extent (length:double) (reg:region))")},
          {"max-extent",
           make_call<double, region, cv_policy_flag>([] (double i, const region& r, cv_policy_flag f) { return arb::cv_policy_max_extent_um(i, r, f); },
