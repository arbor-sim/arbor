...
void register_cells(pybind11::module& m) {
    ...
    density
        .def(pybind11::init([](const std::string& s) { return arb::density(s); }))
        .def(pybind11::init([](arb::mechanism_desc m) { return arb::density(m); }))
        .def(pybind11::init([](arb::mechanism_desc m, const std::unordered_map<std::string, double>& params) { return arb::density(m, params);}))
        .def(pybind11::init([](const std::string& s, const std::unordered_map<std::string, double>& params) { return arb::density(arb::mechanism_desc(s), params);}))
        .def_readonly("mechanism", &arb::density::mech, "The underlying mechanism.")
    ...
    synapse
        .def(pybind11::init([](const std::string& s) { return arb::synapse(s); }))
        .def(pybind11::init([](arb::mechanism_desc m) { return arb::synapse(m); }))
        .def(pybind11::init([](arb::mechanism_desc m, const std::unordered_map<std::string, double>& params) { return arb::synapse(m, params);} ))
        .def(pybind11::init([](const std::string& s, const std::unordered_map<std::string, double>& params) { return arb::synapse(arb::mechanism_desc(s), params);}))
        .def_readonly("mechanism", &arb::synapse::mech, "The underlying mechanism.")
    ...
    junction
        .def(pybind11::init([](const std::string& s) { return arb::junction(s); }))
        .def(pybind11::init([](arb::mechanism_desc m) { return arb::junction(m); }))
        .def(pybind11::init([](arb::mechanism_desc m, const std::unordered_map<std::string, double>& params) { return arb::junction(m, params);} ))
        .def(pybind11::init([](const std::string& s, const std::unordered_map<std::string, double>& params) { return arb::junction(arb::mechanism_desc(s), params);}))
        .def_readonly("mechanism", &arb::junction::mech, "The underlying mechanism.")
