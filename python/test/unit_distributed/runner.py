...
try:
    ...
    import test_domain_decompositions_mpi4py
    import test_domain_decompositions_arbmpi
    # add more if needed
except ModuleNotFoundError:
    from test import options
    from test.unit_distributed import test_contexts_arbmpi
    from test.unit_distributed import test_contexts_mpi4py
    from test.unit_distributed import test_domain_decompositions_mpi4py
    from test.unit_distributed import test_domain_decompositions_arbmpi
    # add more if needed

test_modules = [\
    test_contexts_arbmpi,\
    test_contexts_mpi4py,\
    test_domain_decompositions_mpi4py,\
    test_domain_decompositions_arbmpi\
] # add more if needed
