...
__all__ = ['FileNotFoundError', 'MechCatItemIterator', 'MechCatKeyIterator', 'MechCatValueIterator', 'ValueError', 'allen_catalogue', 'asc_morphology', 'axial_resistivity', 'backend', 'bbp_catalogue', 'benchmark_cell', 'cable', 'cable_cell', 'cable_component', 'cable_global_properties', 'cable_probe_axial_current', 'cable_probe_density_state', 'cable_probe_density_state_cell', 'cable_probe_ion_current_cell', 'cable_probe_ion_current_density', 'cable_probe_ion_diff_concentration', 'cable_probe_ion_diff_concentration_cell', 'cable_probe_ion_ext_concentration', 'cable_probe_ion_ext_concentration_cell', 'cable_probe_ion_int_concentration', 'cable_probe_ion_int_concentration_cell', 'cable_probe_membrane_voltage', 'cable_probe_membrane_voltage_cell', 'cable_probe_point_info', 'cable_probe_point_state', 'cable_probe_point_state_cell', 'cable_probe_stimulus_current_cell', 'cable_probe_total_current_cell', 'cable_probe_total_ion_current_cell', 'cable_probe_total_ion_current_density', 'catalogue', 'cell_cv_data', 'cell_global_label', 'cell_kind', 'cell_local_label', 'cell_member', 'component_meta_data', 'config', 'connection', 'context', 'cv_data', 'cv_policy', 'cv_policy_every_segment', 'cv_policy_explicit', 'cv_policy_fixed_per_branch', 'cv_policy_max_extent', 'cv_policy_single', 'decor', 'default_catalogue', 'density', 'domain_decomposition', 'env', 'event_generator', 'explicit_schedule', 'ext_concentration', 'gap_junction_connection', 'group_description', 'iclamp', 'int_concentration', 'intersect_region', 'ion_data', 'ion_dependency', 'ion_diffusivity', 'ion_settings', 'isometry', 'junction', 'label_dict', 'lif_cell', 'lif_probe_metadata', 'lif_probe_voltage', 'load_asc', 'load_catalogue', 'load_component', 'load_swc_arbor', 'load_swc_neuron', 'location', 'mechanism', 'mechanism_field', 'mechanism_info', 'membrane_capacitance', 'membrane_potential', 'meter_manager', 'meter_report', 'mnpos', 'morphology', 'morphology_provider', 'mpoint', 'msegment', 'neuroml', 'neuroml_morph_data', 'neuron_cable_properties', 'partition_by_group', 'partition_hint', 'partition_load_balance', 'place_pwlin', 'poisson_schedule', 'print_config', 'probe', 'proc_allocation', 'recipe', 'regular_schedule', 'reversal_potential', 'scaled_mechanism', 'schedule_base', 'segment_tree', 'selection_policy', 'simulation', 'single_cell_model', 'spike_recording', 'spike_source_cell', 'stochastic_catalogue', 'synapse', 'temperature_K', 'threshold_detector', 'trace', 'voltage_process', 'write_component']
...
class cable_cell:
    ...
    """
    @typing.overload
    def __init__(self, morphology: morphology, decor: decor, labels: label_dict | None = ...) -> None:
        """
        Construct with a morphology, decor, and label dictionary.
        """
    @typing.overload
    def __init__(self, segment_tree: segment_tree, decor: decor, labels: label_dict | None = ...) -> None:
        """
    ...
    def __str__(self) -> str:
        ...
    def cables(self, label: str) -> list[...]:
        """
        The cable segments of the cell morphology for a region label.
        """
    def locations(self, label: str) -> list[...]:
        """
    ...
    def num_branches(self) -> int:
        ...
        """
component = typing.Union[decor, morphology, label_dict, cable_cell]
...
class cable_global_properties:
    ...
    def check(self) -> None:
        ...
        """
    def set_ion(self, ion: str, valence: float | None = ..., int_con: float | None = ..., ext_con: float | None = ..., rev_pot: float | None = ..., method: typing.Any = ..., diff: float | None = ...) -> None:
        """
        ...
        overriden locally.
        """
    def set_property(self, Vm: float | None = ..., cm: float | None = ..., rL: float | None = ..., tempK: float | None = ...) -> None:
        """
    ...
    def catalogue(self) -> catalogue:
        ...
        """
    @catalogue.setter
    def catalogue(self, catalogue: "catalogue") -> None:
        ...
    @property
    ...
    def ion_data(self) -> dict[str, ion_data]:
        ...
    @property
    def ion_reversal_potential(self) -> dict[str, ...]:
        ...
    @property
...
class cell_cv_data:
    ...
    def __str__(self) -> str:
        ...
    def cables(self, index: int) -> list[...]:
        """
...
class connection:
    ...
    """
    def __init__(self, source: cell_global_label, dest: cell_local_label, weight: float, delay: float) -> None:
        """
...
class decor:
    ...
    def __init__(self, arg0: decor) -> None:
        ...
    def defaults(self) -> list[membrane_potential | axial_resistivity | temperature_K | membrane_capacitance | ion_diffusivity | int_concentration | ext_concentration | reversal_potential | ... | cv_policy]:
        """
    ...
    def paint(self, region: str, mechanism: scaled_mechanism) -> None:
        ...
        """
    @typing.overload
    def paint(self, region: str, Vm: float | str | None = ..., cm: float | str | None = ..., rL: float | str | None = ..., tempK: float | str | None = ...) -> decor:
        """
        Set cable properties on a region.
        """
    @typing.overload
    def paint(self, region: str, *, ion_name: str, int_con: float | None = ..., ext_con: float | None = ..., rev_pot: float | None = ..., diff: float | None = ...) -> decor:
        """
        Set ion species properties conditions on a region.
        """
    def paintings(self) -> list[tuple[str, membrane_potential | axial_resistivity | temperature_K | membrane_capacitance | ion_diffusivity | int_concentration | ext_concentration | reversal_potential | density | voltage_process | scaled_mechanism]]:
        """
    ...
    def placements(self) -> list[tuple[str, iclamp | threshold_detector | synapse | junction, str]]:
        ...
        """
    def set_ion(self, ion: str, int_con: float | None = ..., ext_con: float | None = ..., rev_pot: float | None = ..., method: typing.Any = ..., diff: float | None = ...) -> decor:
        """
        ...
        """
    def set_property(self, Vm: float | None = ..., cm: float | None = ..., rL: float | None = ..., tempK: float | None = ...) -> decor:
        """
...
class density:
    ...
    def __init__(self, name: str, params: dict[str, float]) -> None:
        ...
    @typing.overload
    def __init__(self, mech: mechanism, params: dict[str, float]) -> None:
        ...
    @typing.overload
    def __init__(self, name: str, **kwargs) -> None:
        ...
    @typing.overload
    def __init__(self, mech: mechanism, **kwargs) -> None:
        ...
    def __repr__(self) -> str:
        ...
    def __str__(self) -> str:
...
class domain_decomposition:
    ...
    def num_local_cells(self) -> int:
        ...
        """
schedule = typing.Union[regular_schedule, explicit_schedule, poisson_schedule]
class event_generator:
    def __init__(self, target: cell_local_label, weight: float, sched: schedule) -> None:
        """
...
class explicit_schedule(schedule_base):
    ...
    def times(self) -> list[float]:
        ...
        """
    @times.setter
    def times(self, arg1: list[float]) -> None:
        ...
...
class iclamp:
    ...
    """
    @typing.overload
    def __init__(self, tstart: float, duration: float, current: float, *, frequency: float = 0, phase: float = 0) -> None:
        """
        Construct finite duration current clamp, constant amplitude
        """
    @typing.overload
    def __init__(self, current: float, *, frequency: float = 0, phase: float = 0) -> None:
        """
        Construct constant amplitude current clamp
        """
    @typing.overload
    def __init__(self, envelope: list[tuple[float, float]], *, frequency: float = 0, phase: float = 0) -> None:
        """
...
class morphology_provider:
    ...
    def reify_locset(self, arg0: str) -> list[location]:
        ...
        """
    def reify_region(self, arg0: str) -> "mextent":
        """
...
class poisson_schedule(schedule_base):
    ...
    """
    @typing.overload
    def __init__(self, tstart: float = 0.0, freq: float = ..., seed: int = 0, tstop: typing.Any = None) -> None:
        """
    ...
    def tstart(self) -> float:
        ...
        """
    @tstart.setter
    def tstart(self, arg1: float) -> None:
        ...
    @property
    def tstop(self) -> float | None:
        """
        No events delivered after this time [ms].
        """
    @tstop.setter
    def tstop(self, arg1: typing.Any) -> None:
        ...
class probe:
    def __repr__(self) -> str:
        ...
...
class regular_schedule(schedule_base):
    ...
    """
    @typing.overload
    def __init__(self, tstart: float, dt: float, tstop: typing.Any = None) -> None:
        """
...
class simulation:
    ...
    def deserialize(*args, **kwargs) -> None:
        ...
    def __init__(self, recipe: recipe, context: context = ..., domains: domain_decomposition | None = ..., seed: int = ...) -> None:
        """
    ...
    def reset(self) -> None:
        ...
        """
    def run(self, tfinal: float, dt: float = 0.025) -> float:
        """
    ...
    def serialize(self) -> str:
        ...
        """
    def set_remote_spike_filter(self, pred: typing.Callable) -> None:
        """
...
class single_cell_model:
    ...
    def event_generator(self, event_generator: event_generator) -> None:
        ...
        """
    @typing.overload
    def probe(self, what: str, where: str, tag: str, frequency: float) -> None:
        """
        ...
        """
    @typing.overload
    def probe(self, what: str, where: location, tag: str, frequency: float) -> None:
        """
        Sample a variable on the cell.
         what:      Name of the variable to record (currently only 'voltage').
         where:     Location on cell morphology at which to sample the variable.
         ...
         frequency: The target frequency at which to sample [kHz].
        """
    def run(self, tfinal: float, dt: float = 0.025) -> None:
        """
...
def lif_probe_voltage(tag: str) -> probe:
    ...
    """
def load_asc(filename_or_stream: typing.Any, raw: bool = ...) -> segment_tree | asc_morphology:
    """
    Load a morphology or segment_tree and meta data from a Neurolucida ASCII .asc file.
    """
def load_catalogue(path: str) -> catalogue:
    ...
def load_component(filename_or_descriptor: typing.Union[str, PathLike, object]) -> component:
    """
    Load arbor-component (decor, morphology, label_dict, cable_cell) from file.
    """
def load_swc_arbor(filename_or_stream: typing.Any, raw: bool = ...) -> segment_tree | morphology:
    """
    ...
    """
def load_swc_neuron(filename_or_stream: typing.Any, raw: bool = ...) -> segment_tree | morphology:
    """
...
def write_component(object: cable_cell, filename_or_descriptor: typing.Any) -> None:
    ...
    """
def build_catalogue(name: str, mod_dir: str) -> None:
    """
    Build a catalogue.
    """
def modcc() -> None: ...
