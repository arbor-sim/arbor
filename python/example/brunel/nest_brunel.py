...
nest.CopyModel("static_synapse", "inhibitory_synapse", {"weight":-g*weight, "delay":delay})
...
nest.Connect(pop_exc,pop_inh + pop_exc, conn_spec = {'rule': 'fixed_indegree','indegree': CE}, syn_spec = 'EI_synapse')
