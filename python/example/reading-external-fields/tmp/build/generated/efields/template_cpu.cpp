...
extern "C" {
  arb_mechanism_interface* make_arb_efields_catalogue_template_interface_multicore() {
    static arb_mechanism_interface result;
    result.partition_width = arb::efields_catalogue::kernel_template::simd_width_;
    result.backend = arb_backend_kind_cpu;
    result.alignment = arb::efields_catalogue::kernel_template::min_align_;
    result.init_mechanism = arb::efields_catalogue::kernel_template::init;
    result.compute_currents = arb::efields_catalogue::kernel_template::compute_currents;
    result.apply_events = arb::efields_catalogue::kernel_template::apply_events;
    result.advance_state = arb::efields_catalogue::kernel_template::advance_state;
    result.write_ions = arb::efields_catalogue::kernel_template::write_ions;
    result.post_event = arb::efields_catalogue::kernel_template::post_event;
    return &result;
  }
}
