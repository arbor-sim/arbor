...
morpho = arbor.load_swc_arbor(os.path.join(cell_json_dir, cell_json['morphology']))
...
seaborn.relplot(data=df, kind="line", x="t/ms", y="U/mV",hue="Location",col="Variable",ci=None).savefig('single_cell_bpo.svg')
