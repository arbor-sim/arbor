...
def modcc():
    ...
__config__: dict = {'mpi': False, 'mpi4py': False, 'gpu': None, 'vectorize': True, 'profiling': False, 'neuroml': True, 'bundled': True, 'version': '0.9.1-dev', 'source': '2023-11-29T17:19:01+01:00 6da38a89d33ed51eb4b611c1e85444222b15f60d', 'build_config': 'DEBUG', 'arch': 'native', 'prefix': '/usr/local', 'python_lib_path': '', 'binary_path': 'bin', 'lib_path': 'lib', 'data_path': 'share', 'CXX': '/opt/homebrew/bin/clang++', 'pybind-version': '2.11.1', 'timestamp': 'Nov 29 2023 17:34:30'}
