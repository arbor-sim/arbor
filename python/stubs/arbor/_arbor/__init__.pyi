...
class cable_global_properties:
    ...
    def check(self) -> None:
        ...
        """
    def set_ion(self, ion: str, valence: float | None = None, int_con: float | None = None, ext_con: float | None = None, rev_pot: float | None = None, method: typing.Any = None, diff: float | None = None) -> None:
        """
        ...
        overriden locally.
        """
    def set_property(self, Vm: float | None = None, cm: float | None = None, rL: float | None = None, tempK: float | None = None) -> None:
        """
...
class decor:
    ...
    def __init__(self, arg0: decor) -> None:
        ...
    def defaults(self) -> list[membrane_potential | axial_resistivity | temperature_K | membrane_capacitance | ion_diffusivity | int_concentration | ext_concentration | reversal_potential | reversal_potential_method | cv_policy]:
        """
    ...
    def paint(self, region: str, mechanism: scaled_mechanism) -> None:
        ...
        """
    @typing.overload
    def paint(self, region: str, Vm: float | str | None = None, cm: float | str | None = None, rL: float | str | None = None, tempK: float | str | None = None) -> decor:
        """
        ...
        """
    @typing.overload
    def paint(self, region: str, *, ion: str, int_con: float | None = None, ext_con: float | None = None, rev_pot: float | None = None, diff: float | None = None) -> decor:
        """
    ...
    def placements(self) -> list[tuple[str, iclamp | threshold_detector | synapse | junction, str]]:
        ...
        """
    def set_ion(self, ion: str, int_con: float | None = None, ext_con: float | None = None, rev_pot: float | None = None, method: typing.Any = None, diff: float | None = None) -> decor:
        """
        ...
        overriden locally.
        """
    def set_property(self, Vm: float | None = None, cm: float | None = None, rL: float | None = None, tempK: float | None = None) -> decor:
        """
